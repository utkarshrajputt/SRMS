...
class resultClass:
    def __init__(self,root):
        ...
        # -----------------Title -----------------
        title=Label(self.root,text="Add Student Results",font=("goudy old style",20,"bold"),bg="#E95A48",fg="white").place(x=10,y=15,width=1180,height=40)
...
# -----------------Widgets-----------------
        ...
        lbl_select=Label(self.root,text="Course",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=220)
        
        lbl_select=Label(self.root,text="Marks Obtained",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=280)
        
        lbl_select=Label(self.root,text="Total Marks",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=340)
        # ------------------------------------------
        
        self.txt_student=ttk.Combobox(self.root,textvariable=self.var_roll,values=self.roll_list,font=("goudy old style",17,'bold'),justify=CENTER)
        self.txt_student.place(x=280,y=100,width=200)
        # self.txt_student.set("Select")
        # ------------------------------------------
        btn_search=Button(self.root,text='Search',font=("goudy old style",17,'bold'),bg="#03a9f4",fg="white",cursor="hand2",command=self.search).place(x=500,y=100,width=100,height=35)
        # ------------------------------------------
        ...
        btn_add=Button(self.root,text="Clear",font=("times new roman",15,"bold"),bg="lightgray",activebackground="lightgray",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)
