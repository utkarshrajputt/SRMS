...
class reportClass:
    def __init__(self,root):
        ...
        # -----------------Title -----------------
        title=Label(self.root,text="View Student Results",font=("goudy old style",20,"bold"),bg="#E95A48",fg="white").place(x=10,y=15,width=1180,height=40)
        
        # ------------search--------------------
        self.var_search=StringVar()
        self.var_id=""
        
        lbl_search=Label(self.root,text="Enter Roll No. ",font=("goudy old style",20,"bold"),bg="white").place(x=300,y=100)
        ...
        # ------------------------------------------
        btn_search=Button(self.root,text='Search',font=("goudy old style",17,'bold'),bg="#03a9f4",fg="white",cursor="hand2",command=self.search).place(x=680,y=100,width=100,height=35)
        # ------------------------------------------
        btn_clear=Button(self.root,text='Clear',font=("goudy old style",17,'bold'),bg="gray",fg="white",cursor="hand2",command=self.clear).place(x=800,y=100,width=100,height=35)
        ...
        # -----------------DELETE-------------------------
        btn_delete=Button(self.root,text='Delete',font=("goudy old style",17,'bold'),bg="Red",fg="white",cursor="hand2",command=self.delete).place(x=500,y=350,width=150,height=35)
